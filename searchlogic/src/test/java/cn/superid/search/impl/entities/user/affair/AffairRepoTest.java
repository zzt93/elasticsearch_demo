...
public class AffairRepoTest {
  ...
  public void findAny() throws Exception {
    System.out.println(affairRepo.findAny("开发", null, null, PageRequest.of(0, 10)).getContent());
    System.out.println(affairRepo.findAny("开发部", null, null, PageRequest.of(0, 10)).getContent());
    System.out.println(affairRepo.findAny("后端开发", null, null, PageRequest.of(0, 10)).getContent());
  }

  @Test //SUPERID-313
  public void bugFix313() throws Exception {
    suffix.setSuffix("*");
    System.out.println(affairRepo.findAny("1", null, null, PageRequest.of(0, 10)).getContent());
  }
