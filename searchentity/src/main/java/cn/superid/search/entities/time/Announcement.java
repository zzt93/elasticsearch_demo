...
public class Announcement {
    ...
    @Id @Field(type = FieldType.String, index = FieldIndex.no)
    private String id;
    ...
    public Announcement(String id, String title, String content, List<Tag> tags, String creatorRole, String creatorUser) {
        this.id = id;
        this.title = title;
    ...
    public Announcement(String id, String title, String content, List<Tag> tags, String creatorRole, String creatorUser, long affairId, String affairName, Timestamp modifyTime, long creatorUserId, boolean isTop, int type, String entityMap) {
        this.id = id;
        this.title = title;
        this.content = content;
        this.tags = tags;
